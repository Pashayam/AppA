...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\ndata.proto\"\x14\n\x04Text\x12\x0c\n\x04\x64\x61ta\x18\x01 \x01(\t2.\n\nDataNumber\x12 \n\x0egetPhoneNumber\x12\x05.Text\x1a\x05.Text\"\x00\x62\x06proto3'
)
...
_DATANUMBER = _descriptor.ServiceDescriptor(
  name='DataNumber',
  full_name='DataNumber',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='getPhoneNumber',
    full_name='DataNumber.getPhoneNumber',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_DATANUMBER)

DESCRIPTOR.services_by_name['DataNumber'] = _DATANUMBER
